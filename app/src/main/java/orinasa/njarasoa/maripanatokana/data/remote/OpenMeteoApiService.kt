...
interface OpenMeteoApiService {
    ...
    suspend fun getForecast(
        ...
        @Query("hourly") hourly: String = "temperature_2m,weather_code,precipitation_probability,wind_speed_10m,wind_direction_10m,pressure_msl,precipitation",
        @Query("daily") daily: String = "temperature_2m_max,temperature_2m_min,weather_code,precipitation_probability_max,sunrise,sunset,wind_speed_10m_max,wind_direction_10m_dominant,precipitation_sum,uv_index_max",
